...
Σύμφωνα με το παραπάνω παράδειγμα έχουμε:
...
Γραμμή_5: Αρχικοποιούμε τη μεταβλητή $sum=0. Εάν δεν αρχικοποιούσαμε τη $sum, στη συνέχεια στη γραμμή 9 που χρησιμοποιούμε τη sum θα είχαμε πρόβλημα με errors.
