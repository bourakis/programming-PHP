# ΔΗΜΙΟΥΡΓΙΑ WEB ΕΦΑΡΜΟΓΗΣ ΜΕ PHP & MYSQL


ΟΔΗΓΙΕΣ

1. Δημιουργήστε τα αρχεία php που περιγράφονται παρακάτω
2. Δημιουργήστε μια βάση με το όνομα "jobs"
3. Εισάγετε το αρχείο "example.sql" μέσα στην βάση "jobs"
...
## 2.Δημιουργούμε την σελίδα del.php:
...
## 3.Εισάγουμε το παρακάτω script SQL δημιουργώντας την σελίδα example.sql:
