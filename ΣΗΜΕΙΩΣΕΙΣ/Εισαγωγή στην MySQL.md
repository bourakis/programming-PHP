...
Η εγκατάσταση της mysql μπορεί να γίνει είτε εγκαθυστώντας τον mysql server στην Η/Υ τοπικά, είτε χρησιμοποιώντας λογισμικό εγκατάστασης που εγκαθιστά μια σειρά απο servers εύκολα και γρήγορα στον Η/Υ μας. Τέτοια εργαλεία είναι το XAMPP και το WAMPP. Μπορείτε να επιλέξετε όποιο σας βολεύει καλύτερα. Στα παραδείγματά μας εμείς θα χρησιμοποιήσουμε τον XAMPP.  
