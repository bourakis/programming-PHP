...
Στο παρακάτω παράδειγμα θα δούμε αν η εγγραφή "Peter Parker" καταχωρήθηκε με επιτυχία. Αν καταχωρήθηκε με επιτυχία, τότε θα εμφανιστεί κατά την εκτέλεση του κώδικα.
